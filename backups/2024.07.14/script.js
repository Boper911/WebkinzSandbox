...
function loadCollections(collections) {
    ...
    sortedCollections.forEach(collection => {
        ...
        button.innerHTML = `
            <img src="assets/icons/items/collections/${normalizedCollection.toLowerCase()}.png" alt="${normalizedCollection}" class="icon">
...
function loadFootprints(footprints) {
    ...
    sortedFootprints.forEach(footprint => {
        ...
        button.innerHTML = `
            <img src="assets/icons/items/footprint/checkbox_off.png" alt="Checkbox Off" class="checkbox-icon">
            <span>${footprint}</span>
        `;
        button.onclick = () => {
            const isActive = !button.classList.contains('active');
