...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const checkboxGridWallpaper = document.getElementById('checkboxGridWallpaper');
    if (checkboxGridWallpaper) {
        checkboxGridWallpaper.addEventListener('change', (event) => {
            const gridWallpaper = document.getElementById('gridWallpaper');
            gridWallpaper.style.display = event.target.checked ? 'block' : 'none';
        });
    }

    const checkboxGridFlooring = document.getElementById('checkboxGridFlooring');
    if (checkboxGridFlooring) {
        checkboxGridFlooring.addEventListener('change', (event) => {
